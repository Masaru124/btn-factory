...
class Order(Base):
    ...
    laser: Mapped[str | None] = mapped_column(String(100), nullable=True)
    ...
    po_image: Mapped[str | None] = mapped_column(Text, nullable=True)
    button_image: Mapped[str | None] = mapped_column(Text, nullable=True)
